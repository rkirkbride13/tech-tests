...
RSpec.describe Bank do
  ...
  xit "can deposit and withdraw money and check balance for the total balance values" do
    bank = Bank.new
    bank.deposit_money(1000, "01/01/2023")
    bank.deposit_money(2000, "01/01/2023")
    bank.withdraw_money(500, "01/01/2023")
    expect(bank.check_balance).to eq 2500.00
  end

  xit "can print a statement after a single deposit" do
    bank = Bank.new
    bank.deposit_money(1, "01/01/2023")
    expect(bank.print_statement).to eq "date || credit || debit || balance\n01/01/2023 || 1.00 || || 1.00"
  end

  xit "can print a statement after a single withdrawl" do
    bank = Bank.new
    bank.withdraw_money(1, "01/01/2023")
    expect(bank.print_statement).to eq "date || credit || debit || balance\n01/01/2023 || || 1.00 || -1.00"
  end

  xit "can print a statement after a multiple deposits" do
    bank = Bank.new
    bank.deposit_money(1, "01/01/2023")
    bank.deposit_money(2, "02/01/2023")
    expect(bank.print_statement).to eq "date || credit || debit || balance\n02/01/2023 || 2.00 || || 3.00\n01/01/2023 || 1.00 || || 1.00"
  end

  xit "can print a statement after a multiple withdrawls" do
    bank = Bank.new
    bank.withdraw_money(10, "01/01/2023")
    bank.withdraw_money(25, "02/01/2023")
